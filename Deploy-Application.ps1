...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Execute-MSI -Action 'Install' -Path "rhino5.14.msi" -Parameters "/qn"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'McNeelUpdateService' -silent
		...
		Execute-MSI -Action Uninstall -Path '{8E59DD70-F23E-4CA2-85BC-3C77D74F054F}'
